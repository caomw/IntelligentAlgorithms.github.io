...
cache_flag=false;cache_val=0;Number.prototype.round=function(a){return +(Math.round(this+"e+"+a)+"e-"+a)};Array.prototype.inArray=function(b){for(var a=0;a<this.length;a++){if(b(this[a])){return true}}return false};Array.prototype.pushIfNotExist=function(a,b){if(!this.inArray(b)){this.push(a)}};var LaplaceDensity=function(c,d,a){return 1/(2*a)*Math.exp(-1*Math.abs(c-d)/a)};var stdNormalDistr=function(){if(cache_flag){cache_flag=false;return cache_val}var d=2*Math.random()-1;var b=2*Math.random()-1;var a=d*d+b*b;while(a==0||a>1){d=Math.random()*2-1;b=Math.random()*2-1;a=d*d+b*b}var e=Math.sqrt(-2*Math.log(a)/a);cache_val=b*e;cache_flag=true;return d*e};var normalDistr=function(a,b){return a+stdNormalDistr()*b};function resetfield(b,a){$(b).val(a)}function bisection(d,f,e){var b=e[0];var g=e[1];if(d(e[0])>d(e[1])){var h=b;b=g;g=h}var a=(e[0]==5.8);a=false;var j=0.5*(g+b);for(var c=0;c<50;c++){if(a){console.log("middle "+j+" "+d(j))}if(a){console.log("left "+b+" "+d(b))}if(a){console.log("right "+g+" "+d(g))}if(d(j)<f){b=j}else{g=j}j=0.5*(g+b)}return j}var count=0,overshoot=300;function whenBoundsVisible(f,h){var g=".visible-"+ ++count,b=d3.select(window),e;if(document.readyState==="loading"){b.on("load"+g,d)}else{d()}function d(){b.on("resize"+g,a).on("scroll"+g,c).each(a)}function a(){e=f();if(e[1]<e[0]){e.reverse()}c()}function c(){if(e[0]<=pageYOffset&&pageYOffset<=e[1]){h(null);b.on(g,null)}}}whenFullyVisible=function(a,b){return whenBoundsVisible(function(){var c=a.getBoundingClientRect();return[c.bottom+pageYOffset-innerHeight,c.top+pageYOffset]},b)};!function(a){"undefined"!=typeof exports?a(exports):(window.hljs=a({}),"function"==typeof define&&define.amd&&define([],function(){return window.hljs}))}(function(O){function G(a){return a.replace(/&/gm,"&amp;").replace(/</gm,"&lt;").replace(/>/gm,"&gt;")}function A(a){return a.nodeName.toLowerCase()}function C(b,c){var a=b&&b.exec(c);return a&&0==a.index}function T(a){var b=(a.className+" "+(a.parentNode?a.parentNode.className:"")).split(/\s+/);return b=b.map(function(c){return c.replace(/^lang(uage)?-/,"")}),b.filter(function(c){return k(c)||/no(-?)highlight/.test(c)})[0]}function F(c,d){var a={};for(var b in c){a[b]=c[b]}if(d){for(var b in d){a[b]=d[b]}}return a}function J(b){var c=[];return function a(f,d){for(var g=f.firstChild;g;g=g.nextSibling){3==g.nodeType?d+=g.nodeValue.length:1==g.nodeType&&(c.push({event:"start",offset:d,node:g}),d=a(g,d),A(g).match(/br|hr|img|input/)||c.push({event:"stop",offset:d,node:g}))}return d}(b,0),c}function Q(t,b,x){function d(){return t.length&&b.length?t[0].offset!=b[0].offset?t[0].offset<b[0].offset?t:b:"start"==b[0].event?t:b:t.length?t:b}function m(c){function a(f){return" "+f.nodeName+'="'+G(f.value)+'"'}h+="<"+A(c)+Array.prototype.map.call(c.attributes,a).join("")+">"}function v(a){h+="</"+A(a)+">"}function E(a){("start"==a.event?m:v)(a.node)}for(var N=0,h="",p=[];t.length||b.length;){var n=d();if(h+=G(x.substr(N,n[0].offset-N)),N=n[0].offset,n==t){p.reverse().forEach(v);do{E(n.splice(0,1)[0]),n=d()}while(n==t&&n.length&&n[0].offset==N);p.reverse().forEach(m)}else{"start"==n[0].event?p.push(n[0].node):p.pop(),E(n.splice(0,1)[0])}}return h+G(x.substr(N))}function y(c){function d(f){return f&&f.source||f}function a(e,f){return RegExp(d(e),"m"+(c.cI?"i":"")+(f?"g":""))}function b(f,h){if(!f.compiled){if(f.compiled=!0,f.k=f.k||f.bK,f.k){var n={},g=function(l,i){c.cI&&(i=i.toLowerCase()),i.split(" ").forEach(function(p){var o=p.split("|");n[o[0]]=[l,o[1]?Number(o[1]):1]})};"string"==typeof f.k?g("keyword",f.k):Object.keys(f.k).forEach(function(i){g(i,f.k[i])}),f.k=n}f.lR=a(f.l||/\b[A-Za-z0-9_]+\b/,!0),h&&(f.bK&&(f.b="\\b("+f.bK.split(" ").join("|")+")\\b"),f.b||(f.b=/\B|\b/),f.bR=a(f.b),f.e||f.eW||(f.e=/\B|\b/),f.e&&(f.eR=a(f.e)),f.tE=d(f.e)||"",f.eW&&h.tE&&(f.tE+=(f.e?"|":"")+h.tE)),f.i&&(f.iR=a(f.i)),void 0===f.r&&(f.r=1),f.c||(f.c=[]);var m=[];f.c.forEach(function(i){i.v?i.v.forEach(function(l){m.push(F(i,l))}):m.push("self"==i?f:i)}),f.c=m,f.c.forEach(function(i){b(i,f)}),f.starts&&b(f.starts,h);var e=f.c.map(function(i){return i.bK?"\\.?("+i.b+")\\.?":i.b}).concat([f.tE,f.i]).map(d).filter(Boolean);f.t=e.length?a(e.join("|"),!0):{exec:function(){return null}}}}b(c)}function B(ag,R,ak,Y){function ac(b,c){for(var a=0;a<c.c.length;a++){if(C(c.c[a].bR,b)){return c.c[a]}}}function ai(a,b){return C(a.eR,b)?a:a.eW?ai(a.parent,b):void 0}function af(a,b){return !ak&&C(b.iR,a)}function ae(b,c){var a=u.cI?c[0].toLowerCase():c[0];return b.k.hasOwnProperty(a)&&b.k[a]}function X(g,m,d,f){var b=f?"":z.classPrefix,h='<span class="'+b,c=d?"":"</span>";return h+=g+'">',h+m+c}function ah(){if(!E.k){return G(r)}var f="",c=0;E.lR.lastIndex=0;for(var d=E.lR.exec(r);d;){f+=G(r.substr(c,d.index-c));var b=ae(E,d);b?(V+=b[1],f+=X(b[0],G(d[0]))):f+=G(d[0]),c=E.lR.lastIndex,d=E.lR.exec(r)}return f+G(r.substr(c))}function ad(){if(E.sL&&!j[E.sL]){return G(r)}var a=E.sL?B(E.sL,r,!0,n[E.sL]):I(r);return E.r>0&&(V+=a.r),"continuous"==E.subLanguageMode&&(n[E.sL]=a.top),X(a.language,a.value,!1,!0)}function N(){return void 0!==E.sL?ad():ah()}function aj(c,a){var b=c.cN?X(c.cN,"",!0):"";c.rB?(l+=b,r=""):c.eB?(l+=G(a)+b,r=""):(l+=b,r=a),E=Object.create(c,{parent:{value:E}})}function Z(f,c){if(r+=f,void 0===c){return l+=N(),0}var d=ac(c,E);if(d){return l+=N(),aj(d,c),d.rB?0:c.length}var b=ai(E,c);if(b){var g=E;g.rE||g.eE||(r+=c),l+=N();do{E.cN&&(l+="</span>"),V+=E.r,E=E.parent}while(E!=b.parent);return g.eE&&(l+=G(c)),r="",b.starts&&aj(b.starts,""),g.rE?0:c.length}if(af(c,E)){throw new Error('Illegal lexeme "'+c+'" for mode "'+(E.cN||"<unnamed>")+'"')}return r+=c,c.length||1}var u=k(ag);if(!u){throw new Error('Unknown language: "'+ag+'"')}y(u);for(var E=Y||u,n={},l="",aa=E;aa!=u;aa=aa.parent){aa.cN&&(l=X(aa.cN,"",!0)+l)}var r="",V=0;try{for(var U,ab,s=0;;){if(E.t.lastIndex=s,U=E.t.exec(R),!U){break}ab=Z(R.substr(s,U.index-s),U[0]),s=U.index+ab}Z(R.substr(s));for(var aa=E;aa.parent;aa=aa.parent){aa.cN&&(l+="</span>")}return{r:V,value:l,language:ag,top:E}}catch(W){if(-1!=W.message.indexOf("Illegal")){return{r:0,value:G(R)}}throw W}}function I(f,c){c=c||z.languages||Object.keys(j);var d={r:0,value:G(f)},b=d;return c.forEach(function(e){if(k(e)){var a=B(e,f,!1);a.language=e,a.r>b.r&&(b=a),a.r>d.r&&(b=d,d=a)}}),b.language&&(d.second_best=b),d}function M(a){return z.tabReplace&&(a=a.replace(/^((<[^>]+>|\t)+)/gm,function(b,c){return c.replace(/\t/g,z.tabReplace)})),z.useBR&&(a=a.replace(/\n/g,"<br>")),a}function L(f,g,c){var d=g?q[g]:c,b=[f.trim()];return f.match(/(\s|^)hljs(\s|$)/)||b.push("hljs"),d&&b.push(d),b.join(" ").trim()}function D(f){var h=T(f);if(!/no(-?)highlight/.test(h)){var b;z.useBR?(b=document.createElementNS("http://www.w3.org/1999/xhtml","div"),b.innerHTML=f.innerHTML.replace(/\n/g,"").replace(/<br[ \/]*>/g,"\n")):b=f;var c=b.textContent,g=h?B(h,c,!0):I(c),a=J(b);if(a.length){var d=document.createElementNS("http://www.w3.org/1999/xhtml","div");d.innerHTML=g.value,g.value=Q(a,J(d),c)}g.value=M(g.value),f.innerHTML=g.value,f.className=L(f.className,h,g.language),f.result={language:g.language,re:g.r},g.second_best&&(f.second_best={language:g.second_best.language,re:g.second_best.r})}}function P(a){z=F(z,a)}function K(){if(!K.called){K.called=!0;var a=document.querySelectorAll("pre code");Array.prototype.forEach.call(a,D)}}function w(){addEventListener("DOMContentLoaded",K,!1),addEventListener("load",K,!1)}function S(c,a){var b=j[c]=a(O);b.aliases&&b.aliases.forEach(function(d){q[d]=c})}function H(){return Object.keys(j)}function k(a){return j[a]||j[q[a]]}var z={classPrefix:"hljs-",tabReplace:null,useBR:!1,languages:void 0},j={},q={};return O.highlight=B,O.highlightAuto=I,O.fixMarkup=M,O.highlightBlock=D,O.configure=P,O.initHighlighting=K,O.initHighlightingOnLoad=w,O.registerLanguage=S,O.listLanguages=H,O.getLanguage=k,O.inherit=F,O.IR="[a-zA-Z][a-zA-Z0-9_]*",O.UIR="[a-zA-Z_][a-zA-Z0-9_]*",O.NR="\\b\\d+(\\.\\d+)?",O.CNR="(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",O.BNR="\\b(0b[01]+)",O.RSR="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",O.BE={b:"\\\\[\\s\\S]",r:0},O.ASM={cN:"string",b:"'",e:"'",i:"\\n",c:[O.BE]},O.QSM={cN:"string",b:'"',e:'"',i:"\\n",c:[O.BE]},O.PWM={b:/\b(a|an|the|are|I|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such)\b/},O.CLCM={cN:"comment",b:"//",e:"$",c:[O.PWM]},O.CBCM={cN:"comment",b:"/\\*",e:"\\*/",c:[O.PWM]},O.HCM={cN:"comment",b:"#",e:"$",c:[O.PWM]},O.NM={cN:"number",b:O.NR,r:0},O.CNM={cN:"number",b:O.CNR,r:0},O.BNM={cN:"number",b:O.BNR,r:0},O.CSSNM={cN:"number",b:O.NR+"(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?",r:0},O.RM={cN:"regexp",b:/\//,e:/\/[gimuy]*/,i:/\n/,c:[O.BE,{b:/\[/,e:/\]/,r:0,c:[O.BE]}]},O.TM={cN:"title",b:O.IR,r:0},O.UTM={cN:"title",b:O.UIR,r:0},O});hljs.registerLanguage("matlab",function(d){var b=[d.CNM,{cN:"string",b:"'",e:"'",c:[d.BE,{b:"''"}]}],c={r:0,c:[{cN:"operator",b:/'['\.\+]*/}]};return{k:{keyword:"NaN Inf begin function type immutable let macro for while quote if else elseif try finally catch do end else elseif catch finally if else elseif while for begin let end do try catch finally return break continue global local const export import importall using function macro module baremodule type immutable quote typealias abstract bitstype ccall switch",built_in:"sin sind sinh asin asind asinh cos cosd cosh acos acosd acosh tan tand tanh atan atand atan2 atanh sec secd sech asec asecd asech csc cscd csch acsc acscd acsch cot cotd coth acot acotd acoth hypot exp expm1 log log1p log10 log2 pow2 realpow reallog realsqrt sqrt nthroot nextpow2 abs angle complex conj imag real unwrap isreal cplxpair fix floor ceil round mod rem sign airy besselj bessely besselh besseli besselk beta betainc betaln ellipj ellipke erf erfc erfcx erfinv expint gamma gammainc gammaln psi legendre cross dot factor isprime primes gcd lcm rat rats perms nchoosek factorial cart2sph cart2pol pol2cart sph2cart hsv2rgb rgb2hsv zeros ones eye repmat rand randn linspace logspace freqspace meshgrid accumarray size length ndims numel disp isempty isequal isequalwithequalnans cat reshape diag blkdiag tril triu fliplr flipud flipdim rot90 find sub2ind ind2sub bsxfun ndgrid permute ipermute shiftdim circshift squeeze isscalar isvector ans eps realmax realmin pi inf nan isnan isinf isfinite why compan gallery hadamard hankel hilb invhilb magic pascal rosser toeplitz vander wilkinson sum mean true false enumerate open close nothing print println int float char bool Int Int8 Uint8 Int16 Uint16 Int32 Uint32 Int64 Uint64 Int128 Uint128 Bool Char Float16 Float32 Float64 Array Vector Matrix String UTF8String ASCIIString error warn info printf"},i:'(//|"|#|/\\*|\\s+/\\w+)',c:[{cN:"function",bK:"function",e:"$",c:[d.UTM,{cN:"params",b:"\\(",e:"\\)"},{cN:"params",b:"\\[",e:"\\]"}]},{b:/[a-zA-Z_][a-zA-Z_0-9]*'['\.]*/,rB:!0,r:0,c:[{b:/[a-zA-Z_][a-zA-Z_0-9]*/,r:0},c.c[0]]},{cN:"matrix",b:"\\[",e:"\\]",c:b,r:0,starts:c},{cN:"cell",b:"\\{",e:/\}/,c:b,r:0,i:/:/,starts:c},{b:/\)/,r:0,starts:c},{cN:"comment",b:"#",e:"$"}].concat(b)}});(function(){d3.legend=function(a){a.each(function(){var e=d3.select(this),d={},c=d3.select(e.property("nearestViewportElement")),i=e.attr("data-style-padding")||5,f=e.selectAll(".legend-box").data([true]),b=e.selectAll(".legend-items").data([true]);f.enter().append("rect").classed("legend-box",true);b.enter().append("g").classed("legend-items",true);c.selectAll("[data-legend]").each(function(){var g=d3.select(this);d[g.attr("data-legend")]={pos:g.attr("data-legend-pos")||this.getBBox().y,color:g.attr("data-legend-color")!=undefined?g.attr("data-legend-color"):g.style("fill")!="none"?g.style("fill"):g.style("stroke")}});d=d3.entries(d).sort(function(j,g){return j.value.pos-g.value.pos});b.selectAll("text").data(d,function(g){return g.key}).call(function(g){g.enter().append("text")}).call(function(g){g.exit().remove()}).attr("y",function(j,g){return g+"em"}).attr("x","1em").text(function(g){return g.key});b.selectAll("circle").data(d,function(g){return g.key}).call(function(g){g.enter().append("circle")}).call(function(g){g.exit().remove()}).attr("cy",function(j,g){return g-0.25+"em"}).attr("cx",0).attr("r","0.4em").style("fill",function(g){console.log(g.value.color);return g.value.color});var h=b[0][0].getBBox();f.attr("x",(h.x-i)).attr("y",(h.y-i)).attr("height",(h.height+2*i)).attr("width",(h.width+2*i))});return a}})();(function(){var a=function(d){var i,n,b,b,h=[];var k=300,e=300,j=1;var m;this.setZoom=function(o){j=o;if(b){clearTimeout(b)}b=setTimeout(l)};var f=function(){var u=d.datum();var p=[];var q=u.length;var s=u[0].length;for(var o=0;o<q;o++){p.push(t=[]);for(var v=0;v<s;v++){var r=i(u[o][v],o,v);t.push(r)}}return p};var g=function(p){var o=h[0]*p[0]+h[1]*p[1]+h[2]*p[2];var r=h[3]*p[0]+h[4]*p[1]+h[5]*p[2];var q=h[6]*p[0]+h[7]*p[1]+h[8]*p[2];return[o,r,q]};var c=function(){var v=d.datum();if(!i){return[[]]}var q,p=[];var u=f();var r=v.length;var s=v[0].length;for(var o=0;o<r;o++){p.push(q=[]);for(var w=0;w<s;w++){q.push(g([(o-r/2)/(r*1.41)*k*j,u[o][w]*j,(w-s/2)/(s*1.41)*k*j]))}}return p};var l=function(){var A=d.datum();var s=c();var q=s.length;var w=s[0].length;var o=[];var z=0;for(var v=0;v<q-1;v++){for(var u=0;u<w-1;u++){var r=s[v][u][2]+s[v+1][u][2]+s[v+1][u+1][2]+s[v][u+1][2];o.push({path:"M"+(s[v][u][0]+k/2).toFixed(10)+","+(s[v][u][1]+e/2).toFixed(10)+"L"+(s[v+1][u][0]+k/2).toFixed(10)+","+(s[v+1][u][1]+e/2).toFixed(10)+"L"+(s[v+1][u+1][0]+k/2).toFixed(10)+","+(s[v+1][u+1][1]+e/2).toFixed(10)+"L"+(s[v][u+1][0]+k/2).toFixed(10)+","+(s[v][u+1][1]+e/2).toFixed(10)+"Z",depth:r,data:A[v][u]})}}o.sort(function(y,x){return x.depth-y.depth});var p=d.selectAll("path").data(o);p.enter().append("path");if(m){p=p.transition().delay(m.delay()).duration(m.duration())}p.attr("d",function(x){return x.path});if(n){p.attr("fill",function(x){return n(x.data)})}m=false};this.renderSurface=l;this.setTurtable=function(u,s){var r=Math.cos(s);var q=Math.sin(s);var p=Math.cos(u);var o=Math.sin(u);h[0]=p;h[1]=0;h[2]=o;h[3]=q*o;h[4]=r;h[5]=-q*p;h[6]=-o*r;h[7]=q;h[8]=r*p;if(b){clearTimeout(b)}b=setTimeout(l);return this};this.setTurtable(0.5,0.5);this.surfaceColor=function(o){n=o;if(b){clearTimeout(b)}b=setTimeout(l);return this};this.surfaceHeight=function(o){i=o;if(b){clearTimeout(b)}b=setTimeout(l);return this};this.transition=function(){var o=d3.selection.prototype.transition.bind(d)();colourFunction=null;i=null;o.surfaceHeight=this.surfaceHeight;o.surfaceColor=this.surfaceColor;m=o;return o};this.setHeight=function(o){if(o){e=o}};this.setWidth=function(o){if(o){k=o}}};d3.selection.prototype.surface3D=function(d,c){if(!this.node().__surface__){this.node().__surface__=new a(this)}var b=this.node().__surface__;this.turntable=b.setTurtable;this.surfaceColor=b.surfaceColor;this.surfaceHeight=b.surfaceHeight;this.zoom=b.setZoom;b.setHeight(c);b.setWidth(d);this.transition=b.transition.bind(b);return this}})();MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"],["\\(","\\)"]],processEscapes:!0},TeX:{Macros:{IR:"{\\mathbb{R}}",IC:"{\\mathbb{C}}",IZ:"{\\mathbb{Z}}",IN:"{\\mathbb{N}}",bold:["\\boldsymbol{#1}",1]}}});var d3binding=function(){this.connections=[],this.duration=750,this.ease="linear",this.connect=function(n,t,e){this.connections.push({element:n,property:t,func:e})},this.currentValue=null,this.value=function(){return this.currentValue},this.animate=function(n){this.currentValue=n;var t=this;d3.transition().duration(t.duration).ease(t.ease).each(function(){for(var e=0;e<t.connections.length;e++){var i=t.connections[e],r=function(n){return n};"undefined"!=typeof i.func&&(r=i.func);var a=r(n),o=i.property;i.element.transition().attr(o,a)}})},this.jump=function(n){this.currentValue=n;for(var t=this,e=0;e<t.connections.length;e++){var i=t.connections[e],r=function(n){return n};"undefined"!=typeof i.func&&(r=i.func);var a=r(n),o=i.property;i.element.attr(o,a)}}};var d3binding=function(){this.connections=[];this.duration=750;this.ease="linear";this.connect=function(a,c,b){this.connections.push({element:a,property:c,func:b})};this.currentValue=null;this.value=function(){return this.currentValue};this.animate=function(a){this.currentValue=a;var b=this;d3.transition().duration(b.duration).ease(b.ease).each(function(){for(var e=0;e<b.connections.length;e++){var f=b.connections[e];var c=function(h){return h};if(typeof f.func!=="undefined"){c=f.func}var g=c(a);var d=f.property;f.element.transition().attr(d,g)}})};this.jump=function(b){this.currentValue=b;var e=this;for(var d=0;d<e.connections.length;d++){var f=e.connections[d];var a=function(h){return h};if(typeof f.func!=="undefined"){a=f.func}var g=a(b);var c=f.property;f.element.attr(c,g)}}};/* Modernizr 2.6.2 (Custom Build) | MIT & BSD
